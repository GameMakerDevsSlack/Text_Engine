...
{	
	...
	if ((m[e__YYM.PointB] != undefined) && (m[e__YYM.PointUVB] != undefined))
	{
		...
		{
			var __u = buffer_read(m[e__YYM.PointUVB], buffer_f32);
			var __v = buffer_read(m[e__YYM.PointUVB], buffer_f32);
			
			__u = (__u * uspan) + ubase;
			__v = (__v * vspan) + vbase;
						
			buffer_poke(m[e__YYM.PointB], __uvpos, buffer_f32, __u);
			buffer_poke(m[e__YYM.PointB], __uvpos + 4, buffer_f32, __v);
	...
	if ((m[e__YYM.LineB] != undefined) && (m[e__YYM.LineUVB] != undefined))
	{
		...
		for(__i = 0; __i < numverts; __i++)
		{
			var __u = buffer_read(m[e__YYM.LineUVB], buffer_f32);
			var __v = buffer_read(m[e__YYM.LineUVB], buffer_f32);
			
			__u = (__u * uspan) + ubase;
			__v = (__v * vspan) + vbase;
						
			buffer_poke(m[e__YYM.LineB], __uvpos, buffer_f32, __u);
			buffer_poke(m[e__YYM.LineB], __uvpos + 4, buffer_f32, __v);
	...
	if ((m[e__YYM.TriB] != undefined) && (m[e__YYM.TriUVB] != undefined))
	{
		...
		for(__i = 0; __i < numverts; __i++)
		{
			var __u = buffer_read(m[e__YYM.TriUVB], buffer_f32);
			var __v = buffer_read(m[e__YYM.TriUVB], buffer_f32);
			
			__u = (__u * uspan) + ubase;
			__v = (__v * vspan) + vbase;
						
			buffer_poke(m[e__YYM.TriB], __uvpos, buffer_f32, __u);
			buffer_poke(m[e__YYM.TriB], __uvpos + 4, buffer_f32, __v);
...
if ((currColour != m[e__YYM.Colour]) && ((m[e__YYM.NumPointCols] > 0) || (m[e__YYM.NumLineCols] > 0) || (m[e__YYM.NumTriCols] > 0))) {
	...
	if (m[e__YYM.PointB] != undefined)
	{
		...
		{
			buffer_poke(m[e__YYM.PointB], __offsets[__i], buffer_u32, currColour);
		}
	}
	...
	if (m[e__YYM.LineB] != undefined)
	{
		...
		{
			buffer_poke(m[e__YYM.LineB], __offsets[__i], buffer_u32, currColour);
		}
	}
	...
	if (m[e__YYM.TriB] != undefined)
	{
		...
		{
			buffer_poke(m[e__YYM.TriB], __offsets[__i], buffer_u32, currColour);
		}
	}
